export const BRACK_MARK_IMAGE = "/brack-mark.webp";
export const BRACK_WORDMARK_IMAGE = "/brack-wordmark.webp";
...
export const BRACK_GOALS_IMAGE = "/brack-trophy/brack-goals.webp";
export const BRACK_TROPHY_IMAGE = "/brack-trophy/brack-trophy.webp";

export const BRACK_STREAK_HAPPY_IMAGE = "/brack-streak/brack-streak-image-happy.webp";
export const BRACK_STREAK_SAD_IMAGE = "/brack-streak/brack-streak-image-sad.webp";
...
export const BRACK_ACHIEVEMENT_FIRST_BOOK_IMAGE = "/achievement-badges/achievement_first_book.webp";
export const BRACK_ACHIEVEMENT_BOOKWORM_IMAGE = "/achievement-badges/achievement_book_worm.webp";
export const BRACK_ACHIEVEMENT_CENTURY_READER_IMAGE = "/achievement-badges/achievement_century_reader.webp";
export const BRACK_ACHIEVEMENT_MARATHON_READER_IMAGE = "/achievement-badges/achievement_marathon_reader.webp";
export const BRACK_ACHIEVEMENT_SPEED_READER_IMAGE = "/achievement-badges/achievement_speed_reader.webp";
export const BRACK_ACHIEVEMENT_GENRE_EXPLORER_IMAGE = "/achievement-badges/achievement_genre_explorer.webp";
export const BRACK_ACHIEVEMENT_NIGHT_OWL_IMAGE = "/achievement-badges/achievement_night_owl.webp";
export const BRACK_ACHIEVEMENT_EARLY_BIRD_IMAGE = "/achievement-badges/achievement_early_bird.webp";
export const BRACK_ACHIEVEMENT_CONSISTENT_READER_IMAGE = "/achievement-badges/achievement_consistent_reader.webp";
export const BRACK_ACHIEVEMENT_DEDICATED_READER_IMAGE = "/achievement-badges/achievement_dedicated_reader.webp";

const achievementBadgeImage = (fileName: string) => `/achievement-badges/${fileName}.webp`;

export const BRACK_LOGO_IMAGES = {
  icon: BRACK_MARK_IMAGE,
  full: BRACK_WORDMARK_IMAGE,
} as const;
