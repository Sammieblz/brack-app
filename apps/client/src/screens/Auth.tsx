...
const Auth = () => {
  ...
  const handleEmailAuth = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        variant: "destructive",
        title: isPasswordResetRequest ? "Password reset failed" : "Authentication failed",
        description:
        ...
        <div className="text-center mb-6 md:mb-8 animate-slide-up">
          ...
          <div className="space-y-2">
            <h1 className="font-display text-2xl font-bold text-foreground">
              {isPasswordResetRequest ? "Reset Password" : isSignUp ? "Join BRACK" : "Welcome Back"}
            </h1>
          ...
          <CardContent className="p-4 md:p-6 space-y-4 md:space-y-6">
            ...
            {isPasswordResetRequest && (
              <div className="rounded-md border border-primary/20 bg-primary/5 px-4 py-3 text-sm text-muted-foreground">
                We will send a one-time link to the email on your Brack account.
              </div>
            )}
            ...
            <form onSubmit={handleEmailAuth} className="space-y-4">
              ...
              >
                {loading ? (
                  ...
                  isPasswordResetRequest ? "Send Reset Link" : isSignUp ? "Create Account" : "Sign In"
                )}
              </Button>
            </form>
          </CardContent>
