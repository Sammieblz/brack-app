...
| `discover-readers` | JWT required | Optional limit/filter payload. | Reader recommendations. | Supabase service role/client. | Read-only. | Retry safe; can be expensive as profiles grow. |
